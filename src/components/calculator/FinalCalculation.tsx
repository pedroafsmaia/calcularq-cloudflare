  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6 lg:p-8">
      <SectionHeader
        ...
        description="Revise as horas sugeridas pelo método e finalize sua proposta comercial."
      ...
      <div className="space-y-5">
        <section className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 sm:p-5">
          ...
          <div className="mt-3 rounded-xl border border-calcularq-blue/15 bg-calcularq-blue/5 px-4 py-3">
        ...
        <section className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 sm:p-5">
          <h3 className="text-base font-semibold text-calcularq-blue">Ajustes de preço</h3>
          <p className="mt-1 text-sm text-slate-600">
            Defina a margem de lucro e o prêmio por complexidade para calibrar sua hora técnica ajustada.
          </p>
        ...
        <section className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 sm:p-5">
          <h3 className="text-base font-semibold text-calcularq-blue">Despesas variáveis</h3>
          <div className="mt-3">
            <ExpenseCard
